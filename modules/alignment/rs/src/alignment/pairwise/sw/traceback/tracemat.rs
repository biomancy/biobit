...
use crate::analysis::alignment::pairwise::sw::traceback::{TraceMat, TracedAlignment};
use crate::analysis::alignment::pairwise::{scoring, Op, Step};
...
impl<S: scoring::Score> BestorientationTracer for TraceMatrix<S> {
    type Score = S;
