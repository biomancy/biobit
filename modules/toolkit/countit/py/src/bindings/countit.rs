...
use biobit_core_py::loc::IntoPyLocus;
use biobit_core_py::{
...
pub struct PyCountIt(
    CountIt<String, usize, f64, PyObject, usize, PyObject, Box<SegmentedAlignmentSource>>,
);
...
impl PyCountIt {
    ...
    pub fn add_annotation(
        ...
        slf.0.add_annotation(data, todo!(), intervals);
